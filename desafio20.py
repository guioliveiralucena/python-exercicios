...
sorteio2 = random.choice(lista_alunos)
sorteio3 = random.choice(lista_alunos)
sorteio4 = random.choice(lista_alunos)

print('O aluno primeiro escolhido foi {}, o segundo foi {}, o terceiro foi {} e o quarto é {}'.format(sorteio, sorteio2, sorteio3, sorteio4))
